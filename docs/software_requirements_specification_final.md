...
| NFR7 | A user shall not be able to create an account until they have created a strong password. |
...
| :-------------: | :----------: | :----------: |
| UseCase1 | Borrow Book | FR11,  FR12 |
| UseCase1 | Return Book | FR16,  FR17 |
| UseCase2 | Apply overdue fee | FR19 |
| UseCase2 | Validate the return of the book | FR20 |
| UseCase3 | Add customer | FR4 |
| UseCase3 | Add/Delete book | FR5 |
| UseCase3 | Search for Book | FR21, FR22, NFR3 |
| UseCase3 | Login | FR1, FR2 |
| UseCase4 | Receive Email Updates | FR13, FR18 |
...
| Artifact ID | Artifact Name | Requirement ID |
| :-------------: | :----------: | :----------: |
| Acivity1 | Borrow Book | FR11-15 |
| Acivity1 | Return Book | FR16-20 |
| Acivity2 | Create new customer | FR4 |
